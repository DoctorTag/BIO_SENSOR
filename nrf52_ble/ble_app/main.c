...
#define DEVICE_NAME                     "FeelKit"                               /**< Name of device. Will be included in the advertising data. */
...
*/
/*
static uint32_t test_gpiote_pad(uint32_t pin)
{
    uint32_t err_code;
